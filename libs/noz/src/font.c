...
inline font_impl_t* to_impl(void* s) { return (font_impl_t*)to_object((s), type_font); }
...
font_t* font_load_from_stream(allocator_t* allocator, stream_t* stream, const name_t* name)
{
    // Read header
