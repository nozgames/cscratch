...
bool TextureImporter::can_import(const std::string& filePath) const
{
...
void TextureImporter::process_texture(const std::string& sourcePath, const std::string& outputPath)
{
